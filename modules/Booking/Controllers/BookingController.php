...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function detail(Request $request, $code)
    {
       ...
       // dd($booking);
        $text = "<b>Booking Id: </b>".$booking->code."\r\n";
        $text .= "<b>First name: </b>".$booking->first_name."\r\n";
        $text .= "<b>Last name: </b>".$booking->last_name."\r\n";
        $text .= "<b>Email: </b>".$booking->email."\r\n";
        $text .= "<b>Phone: </b>".$booking->phone."\r\n";
        $text .= "<b>Address 1: </b>".$booking->address."\r\n";
        $text .= "<b>Address 2: </b>".$booking->address2."\r\n";
        $text .= "<b>City : </b>".$booking->city."\r\n";
        $text .= "<b>State: </b>".$booking->state."\r\n";
        $text .= "<b>Country: </b>".$booking->country."\r\n";
        $text .= "<b>Special requirements: </b>".$booking->customer_notes."\r\n";
